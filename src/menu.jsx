...
//         {/* Signature Starters */}
//         <motion.div
//           className="bg-white/80 p-8 border border-white hml-4 w-50"
//           style={{ padding: "15px" }}
...
function Menu() {
  ...
  return (
    ...
    >
      <div className="flex flex-row gap-4 justify-center translate-y-12 items-start overflow-x-auto">
        {/* Signature Starters */}
        <motion.div
          className="bg-white/80 p-4 border border-white w-64 min-w-[250px] h-[310px]"
          variants={variants}
          initial="hidden"
          animate="visible"
        >
