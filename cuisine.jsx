...
function Cuisine() {
  ...
  return (
    <div className="w-screen h-screen flex items-center justify-center px-8 relative bg-[#1a1206] text-white overflow-hidden">
      ...
      {/* Main Content */}
      <div className="absolute  top-[120px] bottom-[90px] w-[1000px] text-[#f6e4d3] p-6 flex flex-col gap-12">
        <h2 className="text-4xl font-semibold mb-12 text-center">OUR SIGNATURE DISHES</h2>
        ...
        <div className="relative">
          ...
          >
            {[
              { id: 1, title: 'Mango Sushi', img: '/public/sushi.jpg' },
              { id: 2, title: 'Paneer Tikka', img: '/public/paneertikka.jpg' },
              { id: 3, title: 'Ramen Delight', img: '/public/ramen.jpg' },
              { id: 4, title: 'Spring Rolls', img: '/public/spring rolls.jpg' },
              { id: 5, title: 'Fusion Biryani', img: '/public/biryani.jpg' },
            ].map((dish) => (
              <div
                key={dish.id}
